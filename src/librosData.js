const librosData = [
    ...
    {
      titulo: 'Mitología Celta',
      sinopsis: 'Los mitos celtas nos hablan de grandes guerreros, dioses secretos, bosques sagrados y magia; las narraciones han sido conservadas durante siglos por la tradición oral y los manuscritos medievales. En las últimas décadas, el mundo presencia un recital que se refleja en un renovado interés por la tradición, el arte y la música celta. Este libro recorre la historia del pueblo celta, sus costumbres y religión, el modo en que la arqueología ha logrado reconstruir su cultura, y la sabiduría de los famosos sacerdotes druidas y los legendarios bardos. Pero sobre todo, recopila las leyendas de la literatura celta, en especial la irlandesa y galesa, con narraciones maravillosas sobre viajes al Otro Mundo, sagas de guerreros de poderes sobrenaturales y heroínas trágicas como Deirdre o Isolda y se detiene en clásicos relatos de hadas y duendes para finalmente acercarse al Rey Arturo, ese héroe celta convertido en personaje romántico. La mitología celta es un mundo complejo de rara belleza, cuya maravillosa voz se niega a desaparecer en el tiempo. Este trabajo busca acercar al lector a los mitos y leyendas de la antigua Europa celta, y quiere servir como introducción para todos aquellos que quieran comprender una de las culturas más fascinantes de la Historia',
      añoPublicacion: 2007,
    },
    {
      titulo: 'Mitolgía Egipcia ',
      sinopsis: 'Tesoros, momias, pirámides y el nombre de Tutankhamón son sinónimos de una civilización que aún hoy deslumbra cuando hablamos de un pueblo que vivió, incluso, cuando el continente europeo no se había organizado civilmente. Herodoto escribía: "Egipto es un regalo del Nilo", y partiendo de esta definición sobre un país al que sus antiguos pobladores le dieron el nombre de Kemi (Tierra negra), acercamos esta introducción a la mitología egipcia caracterizada por sus misterios, creencias y dioses que se desarrollaron en sus casi cinco mil años de historia.',
      añoPublicacion: 2007,
    },
    {
      titulo: 'Alguien camina sobre tu tumba',
      sinopsis: 'Este libro reúne una serie de muy particulares crónicas de viajes por medio mundo. La autora recorre países y continentes para visitar algo muy concreto y acaso inusual: cementerios. Desfilan por estas páginas campo­santos célebres y cargados de historia como el de Montparnasse de París, el de Highgate en Londres o el cementerio judío de Praga, y otros recónditos, decrépi­tos, remotos o secretamente bellos. Asoman tumbas de personajes famosos–la de Elvis en Memphis, la de Marx en Londres...–, epitafios extravagantes, escultu­ras dolientes, ángeles sensuales, rastros de vudú en Nueva Orleans, escritores románticos, criptas góticas, catacumbas, esqueletos, vampiros, fantasmas y una inagotable retahíla de leyendas e historias: el poeta enterrado de pie, la tumba del caballo fiel... Y hay lugar también para hacer el amor entre las lápidas o para ro­bar un hueso y ponerle nombre.',
      añoPublicacion: 2013,
    },
    {
